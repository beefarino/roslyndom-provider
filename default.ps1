<#
    ...
    Build script for RoslynDom module
#>

properties {
	$config = 'Debug'; 	
	$slnFile = @(
		'./src/CodeOwls.RoslynDOMProvider.sln'
	);	
    $targetPath = "./src/CodeOwls.RoslynDOMProvider/bin";
    
    $moduleName = "RoslynDom";
	$moduleSource = "./src/Modules";
    $metadataAssembly = 'CodeOwls.RoslynDomProvider.dll'
    $currentReleaseNotesPath = '.\src\Modules\RoslynDom\en-US\about_RoslynDom_Version.help.txt'
};
